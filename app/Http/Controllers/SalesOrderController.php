        ...
        try{
            ...
            if ($form_data['salePaymentMethod'] == "Installment"){
                for ($i=1; $i < $form_data['number_of_checkbox']; $i++) { 
                    ...
                    if($form_data['installmentType']=="3 months"){
                        $payment_log->amount_paid = ($form_data['costPrice']-$form_data['saleDownpaymentCost'])/3;
                    }
                    else if($form_data['installmentType']=="6 months"){
                        $payment_log->amount_paid = ($form_data['costPrice']-$form_data['saleDownpaymentCost'])/6;
                    }
                    else if($form_data['installmentType']=="12 months"){
                        $payment_log->amount_paid = ($form_data['costPrice']-$form_data['saleDownpaymentCost'])/12;
                    }
